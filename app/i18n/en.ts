export const en = {
    ...
    audioInputDrop: 'Drop a track here',
    audioInputFormats: 'MP3, WAV, FLAC, OGG',
    audioInputReady: 'Track read',
    audioInputTitle: 'Audio in',
    audioInputHint: 'Start a song from a finished track',
    audioInputPlaceholder: 'Path to a track — MP3, WAV, FLAC',
    audioInputRead: 'Read the track',
    audioInputReading: 'Reading…',
    audioInputExplain: 'The track is turned into the codes the model speaks and replayed whole: the melody and the structure come from your file, the sound from the description and the lyrics. This is not a continuation and not an edit of one section.',
