export const en = {
    ...
    toolsHeading: 'Runtimes, packages and compatibility',
    toolsIntro: 'Native engine diagnostics, installed model packages and OpenRouter capabilities for this Music3 desktop runtime.',
